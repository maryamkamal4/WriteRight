...
def marking(image_path1, image_path2):
    ...
    cv2.drawContours(canvas, [max_contour1_resized +
                              translation1], -1, (0, 255, 0), thickness=2)
    cv2.drawContours(canvas, [max_contour2_resized +
                              translation2], -1, (255, 0, 0), thickness=2)
